<?php
    ...
    public function altera($id){
        ...
        $return[] = array(
               'ID'=>$result['ID_DADOS'],
               'DATA_PROD'=>$result['DATA_PROD'],
               'EXTRUSORA'=>$result['EXTRUSORA'],
               'TURNO'=>$result['TURNO'],
               'OPERADOR'=>$result['OPERADOR'],
               'PROD_KG'=>$result['PROD_KG'],
               'APARA'=>$result['APARA'],
               'REFILE'=>$result['REFILE'],
               'BORRA'=>$result['BORRA'],
               'ACABAMENTO'=>$result['ACABAMENTO'],
               'QTD_PARADA'=>$result['QTD_PARADA'],
               'TEMPO_PARADA'=>$result['TEMPO_PARADA'],
               'OC'=>$result['OC']           
           );
            echo json_enconde($return);
