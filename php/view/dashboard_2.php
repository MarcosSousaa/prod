    ...
    <body>
        <div class="row" id="panel">
                ...
                <div class="col s3">
                    <table class="striped">
                        <thead>
                            ...
                            <th>Perda(KG)</th>
                            <th><strong style="color: blue;">Total Produzido</strong></th>                                
                        </thead>
                        <tbody>
                            <tr>
                                <td><?php echo number_format($grafico[0][0],3,",",".");?></td>
                                <td><?php echo number_format($grafico[0][1],3,",",".");?></td>
                                <td style="color: blue;"><?php echo number_format($grafico[0][0] + $grafico[0][1],3,",",".");?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row">                            
                ...
                <div class="analitico">                    
                    <div class="col s6">                        
                        <p><strong style="color: red;">Perda Analitica Por Extrusora</strong></p>
                        ...
                        <table class="striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Borra(KG)</th>
                                    <th>Acabamento(KG)</th>
                                    <th style="color: blue;">Total Perda por Extrusora(KG)</th>
                                </tr>                                                                    
                            </thead>
                            <tbody>
                                 <tr>
            ...
            <div class="row">
                ...
                <div class="analitico">                    
                        <div class="col s6">                        
                            <p><strong style="color: red;">Perda Analitica Por Turno</strong></p>
                            ...
                            <table class="striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Borra(KG)</th>
                                        <th>Acabamento(KG)</th>
                                        <th style="color: blue;">Total Perda Por Turno(KG)</th>
                                    </tr>                                                                    
                                </thead>
                                <tbody>
                                <tr>
                                    <td><?php echo $grafico[6][1];?></td>
                                    <td><?php echo number_format($grafico[6][3],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[6][4],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[6][5],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[6][6],3,",",".");?></td>
                                    <td style="color: blue;"><strong><?php echo number_format($grafico[6][3] + $grafico[6][4] + $grafico[6][5] + $grafico[6][6],3,",",".");?></strong></td>
                                </tr>
                                <tr>
                                    <td><?php echo $grafico[7][1];?></td>
                                    <td><?php echo number_format($grafico[7][3],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[7][4],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[7][5],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[7][6],3,",",".");?></td>
                                    <td style="color: blue;"><strong><?php echo number_format($grafico[7][3] + $grafico[7][4] + $grafico[7][5] + $grafico[7][6],3,",",".");?></strong></td> 
                                </tr>
                                <tr>
                                    <td><?php echo $grafico[8][1];?></td>                                                                
                                    <td><?php echo number_format($grafico[8][3],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[8][4],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[8][5],3,",",".");?></td>
                                    <td><?php echo number_format($grafico[8][6],3,",",".");?></td>
                                    <td style="color: blue;"><strong><?php echo number_format($grafico[8][3] + $grafico[8][4] + $grafico[8][5] + $grafico[8][6],3,",",".");?></strong></td> 
                                </tr>                            
                                <tr>
                                    <td><strong style="color: blue;">TOTAL GERAL</strong></td>
                                    <td><strong style="color: blue;"><?php echo number_format($grafico[6][3] + $grafico[7][3] + $grafico[8][3],3,",",".");?></strong></td>
                                    <td><strong style="color: blue;"><?php echo number_format($grafico[6][4] + $grafico[7][4] + $grafico[8][4],3,",",".");?></strong></td>
                                    <td><strong style="color: blue;"><?php echo number_format($grafico[6][5] + $grafico[7][5] + $grafico[8][5],3,",",".");?></strong></td>
                                    <td><strong style="color: blue;"><?php echo number_format($grafico[6][6] + $grafico[7][6] + $grafico[8][6],3,",",".");?></strong></td>   
                                    <td><strong style="color: blue;"><?php echo number_format($grafico[6][3] + $grafico[7][3] + $grafico[8][3] + $grafico[6][4] + $grafico[7][4] + $grafico[8][4]  + $grafico[6][5] + $grafico[7][5] + $grafico[8][5] + $grafico[6][6] + $grafico[7][6] + $grafico[8][6],3,",",".");?></strong></td>   
                                </tr>
                                </tbody>                                     
                            </table>
                        </div>
        ...
        <script>            
            ...
            var myDoughnutChart = new Chart(ctx6, {
                ...
                data: {                                       
                    datasets: [{                        
                        label: 'Apara',
                        data: [<?php echo $grafico[6][3]; ?>,<?php echo $grafico[7][3]; ?>,<?php echo $grafico[8][3]; ?>],
                        backgroundColor: [
                            'rgba(41, 128, 185,1.0)',
                            'rgba(41, 128, 185,1.0)',
                            'rgba(41, 128, 185,1.0)',
                    ...
                    {                        
                        label: 'Refile',
                        data: [<?php echo $grafico[6][4]; ?>,<?php echo $grafico[7][4]; ?>,<?php echo $grafico[8][4]; ?>],
                        backgroundColor: [                            
                            'rgba(192, 57, 43,1.0)',                        
                            'rgba(192, 57, 43,1.0)',                        
                            'rgba(192, 57, 43,1.0)',                        
                      ...
                      {                        
                        label: 'Borra',
                        data: [<?php echo $grafico[6][5]; ?>,<?php echo $grafico[7][5]; ?>,<?php echo $grafico[8][5]; ?>],
                        backgroundColor: [                            
                            'rgba(39, 174, 96,1.0)',                        
                            'rgba(39, 174, 96,1.0)',
                            'rgba(39, 174, 96,1.0)',
                      ...
                      {                        
                        label: 'Acabamento',
                        data: [<?php echo $grafico[6][6]; ?>,<?php echo $grafico[7][6]; ?>,<?php echo $grafico[8][6]; ?>],
                        backgroundColor: [                            
                            'rgba(233, 212, 96,1.0)',
                            'rgba(233, 212, 96,1.0)',
                            'rgba(233, 212, 96,1.0)',
